<x-guest-layout>
    ...
    <div class="flex flex-col text-sm">
        ...
        <form class=" mt-24 flex flex-col w-1/4 gap-4 self-center items-center" method="POST"
            ...
            <p class="text-left w-full">New user? <a class="font-black"href="{{ route('register') }}">Create an account</a></p>
            <div class="w-full">
            ...
            @if (Route::has('password.request'))
                <a class="self-end underline text-sm text-gray-600 hover:text-gray-700  rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 " href="{{ route('password.request') }}">
